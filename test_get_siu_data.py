...
from pysiu import process_siu_jobs


def processing_function(siu_data_dict, logger):
    """
    ...
    siu_job_dict = {
        'session1': {'siu_user': 'admin',
                     ...
                     'command_list': [
                         ...
                         'getMOAttribute STN=0,EthernetInterface=5',
                         'getMOAttribute STN=0,synchronization=0,Timeserver=all',
                         'getMOAttribute STN=0,TrafficManager=QoS_WAN',
                         'getMOAttribute STN=0,Localconnect=0',
                         'dump -l',
                     ],
        },
    }
...
if siu_fdn_list == []:
    ...
    # Create and launch a multiprocessor of the SIU jobs
    process_siu_jobs.Multiprocess_SIU(json_dump_full_filename,
                                                  logger, siu_data_dict_list,
                                                  processing_function,
                                                  num_workers=40)
